...
def main():
    ...
    état.ecs = ECS()
    ajouter_type_composant(état.ecs, Débogage, Position, Sprite, Force, MouvementGrillage, Joueur)
    ajouter_système(état.ecs, déplacer_carré_débogage, appliquer_effets_tuiles, appliquer_mouvement_grillage, appliquer_forces)
